...
export namespace SHSError {
  export function errorResponse (request:SHSRequest | null, httpStatusCode: number | null, type: string, message: string): SHSError {
    return new SHSError(request, httpStatusCode, type, message)
  }

  export function errorResponseFromError (alexaRequest: SHSRequest | null, error: any): SHSError {
  ...
  export function errorResponseForWrongDirectiveNamespace (alexaRequest:SHSRequest, namespace: string): SHSError {
    return new SHSError(
      alexaRequest,
      400,
      'INVALID_DIRECTIVE',
  ...
  export function errorResponseForInvalidDirectiveNamespace (alexaRequest:SHSRequest): SHSError {
    return new SHSError(
      alexaRequest,
      400,
      'INVALID_DIRECTIVE',
  ...
  export function errorResponseForInvalidDirectiveName (alexaRequest:SHSRequest): SHSError {
    return new SHSError(
      alexaRequest,
      400,
      'INVALID_DIRECTIVE',
  ...
  export function errorResponseForInvalidValue (alexaRequest:SHSRequest, parameter: string): SHSError {
    return new SHSError(
      alexaRequest,
      400,
      'INVALID_VALUE',
