...
[alexa-for-lg-webos-tv](../../../../../modules.md) / [skill/lib/link/request](../README.md) / request

# Function: request()

> **request**(`requestOptions`, `bearerToken`, `requestBody?`): `Promise`\<`object`\>

This function makes the HTTPS request specified by [requestOptions](#request).
The HTTPS request authenticates itself to the receiver by including
[bearerToken](#request) as the bearer token in the HTTP authorization header. If
[requestBody](#request) is provided, then the request is made using the HTTP
...
received. Otherwise, this function throws a [HttpCommonError](../../http-common-error/classes/HttpCommonError.md).
