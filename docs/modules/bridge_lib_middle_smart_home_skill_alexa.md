[alexa-for-lg-webos-tv](../README.md) / [Modules](../modules.md) / bridge/lib/middle/smart-home-skill/alexa

# Module: bridge/lib/middle/smart-home-skill/alexa

## Table of contents

### Functions

- [capabilities](bridge_lib_middle_smart_home_skill_alexa.md#capabilities)
- [handler](bridge_lib_middle_smart_home_skill_alexa.md#handler)
- [states](bridge_lib_middle_smart_home_skill_alexa.md#states)
