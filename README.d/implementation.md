...
Under the hood, the software does several things that I believe are worth documenting because I was not able to find examples on the internet. If you want to really look under the hood, you can take a look at the autogenerated [Source Code API](./source-code-api/README.md).
