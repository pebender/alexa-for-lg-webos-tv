...
async function smartHomeSkillHandler(event: AlexaRequest, context: any, callback: (error: any, response: AlexaResponse) => void): Promise<void> {
    try {
...
function skilllHandler(event: any, context: any, callback: (error: any, response: any) => void): Promise<void> {
